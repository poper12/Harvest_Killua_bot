...
#--------------------------------------------
#Bot token @Botfather
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8104175594:AAE--rOpvYm00jmxIkBkUcFGd0Lk5z-wpG4")
APP_ID = int(os.environ.get("APP_ID", "20445873")) #Your API ID from my.telegram.org
API_HASH = os.environ.get("API_HASH", "057fd0be9d7c38526b143c582bceb24b") #Your API Hash from my.telegram.org
#--------------------------------------------

CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002521004548")) #Your db channel Id
OWNER = os.environ.get("OWNER", "Aaru_2074") # Owner username without @
